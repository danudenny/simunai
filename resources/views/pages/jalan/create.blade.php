...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('jalan.store') }}" method="POST" enctype="multipart/form-data" name="tambah_jalan"
            class="forms-sample">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-484">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="panjang" placeholder="0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="lebar" placeholder="0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="th_data" placeholder="2021">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="titik_pengenal_awal"
                                        placeholder="Titik Pengenal Awal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="titik_pengenal_akhir"
                                        placeholder="Titik Pengenal Akhir">
                    ...
                    <div class="card card-484">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="baik" placeholder="0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="sedang" placeholder="0">
                                    <span class="text-danger">{{ $errors->first('sedang') }}</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="namaRuasInput" class="col-sm-3 col-form-label">Panjang Rusak Ringan
                                    (km)</label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="rusak_ringan" placeholder="0">
                                    <span class="text-danger">{{ $errors->first('rusak_ringan') }}</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="namaRuasInput" class="col-sm-3 col-form-label">Panjang Rusak Berat
                                    (km)</label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="rusak_berat" placeholder="0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group col-xs-12 control-group increment">
                                        <input type="file" name="images[]" class="form-control file-upload-info"
                                            placeholder="Pilih Gambar" accept="*/*">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-success add-img"
                                                type="button">Tambah Gambar</button>
                                        </span>
                                    </div>
                                    <div class="clone hide">
                                        <div class="input-group control-group col-xs-12">
                                            <input type="file" name="images[]" class="form-control file-upload-info"
                                                placeholder="Pilih Gambar" accept="*/*">
                                            <span class="input-group-append">
                                                <button class="file-upload-browse btn btn-danger rem-img"
                                                    type="button">Hapus Gambar</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary pull-right"><i class="ik ik-save"
                                    title="Simpan"></i> Simpan</button>
                            <a onclick="return confirm('Apakah anda yakin keluar? Data tidak akan disimpan.')"
                                class="btn btn-light pull-right mr-2 " href="{{ route('jalan') }}"><i
                                    class="ik ik-repeat" title="Cancel"></i> Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
